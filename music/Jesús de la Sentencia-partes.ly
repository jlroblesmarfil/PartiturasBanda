...
trombon_ter = \relative c {
  ...
  \key ees \major
    ...
    \repeat unfold 2 {g4 r g2->} | r4 ees r ees | r ees2 ees4 | r ees r ees |
    ...
    \bar "||"
    r\mf g r g | r g2 g4 | r g r g | r g2 g4-> | r4 aes r g | r g2 g4 |
    ...
    \alternative {
      ...
      { ees8. d16 c4 (c8.) c16 bes?8. aes?16 | g4 f8. ees16 d8. c16 d8. ees16 | %\break
      }
    }
    c4 r d2-> 
    \bar "||" \key c \minor

	ees1 (ees4) r r2 | r2\pp d-> | r4 ees2 ees4 | r ees r ees | r ees r ees |
    ...
    r2  aes-> | r4 g2 g4 | r g r g | %\break
    r g r aes | r aes2 aes4 | aes r r2 | r aes-> | r4 g2 g4 | r g r g | r f r f | r f r f | r f r f |%\break
    r aes r aes | r g2 g4 | g r r2 | aes2 g4 g | g g2-> g4 |  g-> g8.-> g16-> g-> r8 r4
    \bar "|."
}
